...
export const portfolioData = [
    ...
    description: "This webapp will allow user to be able to find adoption centers nearby, animals held by centers, and directions to them."
    },
    {
    id: 3,
    ...
    description: "A MongoDB database that stores users inputs and displays it by the API route"
    },
    {
    id: 6, 
    name: "Task Board", 
    ...
    description: "A simple task board that allows users to create tasks, assign due date and move them from one column to the next. The cards change colors if the due date is past, current or in the future."
    },
]
...
/* 
    ...
    name: "", 
    github: "", 
    img: "https://michael-hellon.github.io/React-Portfolio/src/assets/images/IMAGE_NAME.png", 
    description: ""
    },
*/ 